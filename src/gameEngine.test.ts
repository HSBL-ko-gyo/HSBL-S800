...
describe('game engine', () => {
  ...
  it('draws, discards, and passes the turn', () => {
    ...
    expect(drawn.wall).toHaveLength(83)
  ...
  it('runs through the full wall and ends in a draw', () => {
    ...
    expect(game.turnNumber).toBe(84)
    expect(game.players.reduce((total, player) => total + player.river.length, 0)).toBe(84)
  })
})
